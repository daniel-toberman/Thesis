#!/usr/bin/env python3
"""
Evaluate Hybrid CRNN-SRP System with Temperature + Mahalanobis (Combined Training Data)

This script:
1. Loads trained Temperature + Mahalanobis models (from combined 6cm + 3x12cm training)
2. Gets routing decisions on test set
3. Runs SRP on cases routed to SRP
4. Combines CRNN (kept) + SRP (routed) for real hybrid performance
"""

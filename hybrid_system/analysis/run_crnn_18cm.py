...
def backup_and_modify_recorddata():
    ...
    print("🔧 Modifying CRNN for 18cm array...")
    ...
    if original_line in content:
        ...
        print(f"✅ Modified CRNN to use 18cm array: [0, 17, 18, 19, 20, 21, 22, 23, 24]")
        return True
    else:
...
def run_crnn_test():
    ...
    print("🧠 Running CRNN test with 18cm array...")
    ...
    try:
        ...
        if result.returncode == 0:
            print("✅ CRNN 18cm test completed successfully")
            ...
            print(f"❌ CRNN 18cm test failed with return code {result.returncode}")
...
def save_results():
    ...
    print("💾 Looking for CRNN 18cm results...")
    ...
    for location in possible_locations:
        ...
        if path.exists():
            if path.is_file() and path.suffix == '.csv':
                ...
                print(f"📊 Copied CRNN 18cm results to: {dest}")
                ...
                try:
                    ...
                    if 'abs_error' in df.columns:
                        ...
                        print(f"🎯 CRNN 18cm MAE: {mae:.2f}°")
                        print(f"🎯 CRNN 18cm Median: {median_error:.2f}°")
                        print(f"🎯 CRNN 18cm Success Rate (≤5°): {success_rate:.1f}%")
...
def main():
    ...
    print("🚀 Running CRNN with 18cm Array Configuration")
    print("=" * 60)
